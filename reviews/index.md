...
| Target | State |
|---|---|
| 015 sameday shipping | **v3 fix round resolved 2026-07-27** (`5fc330b`) — all 3 cert blockers (D43/D44/D45) + mediums fixed + 8 backlog folded in; D45 durable claim approach-checked, fix diff micro-reviewed clean; backend 898/frontend 452 green. **Re-verification + re-certification next.** D45 crash residual: verify Sameday idempotency before enabling. Still dormant behind two false flags |
