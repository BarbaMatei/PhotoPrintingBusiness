...
|------|--------|--------|---------|----------|--------|---------------|------------|
| 2026-07-04 | Bolt 035 — payment idempotency | `feat/bolt-035-payment-idempotency` | Approve-with-followups (v9 verification of resolution-v8) | 0 / 2 / 9 / 7 | **13 verified · 1 fixed (OBS-3, doc drift re-fixed) · 4 accepted-deferred · 0 open.** v9 (4 anchored lenses + build/test) verified OBS-1/BUG-1/BUG-3/BUG-4/SEC-2/REQ-1/OBS-2/QUAL-1–6, re-affirmed the migration/deploy deferrals (DB-1, DB-2, SEC-1, BUG-2) sound, and reopened OBS-3 for incomplete doc alignment (fixed @065a516). 0 regressions, tenant isolation intact, **487/487 green**. Fix loop complete; feature-closure still wants a saturated discovery pass. | [v9](035-payment-idempotency/review-v9.md) | [v8](035-payment-idempotency/resolution-v8.md) |
