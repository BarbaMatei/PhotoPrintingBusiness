...
|------|--------|--------|---------|----------|--------|---------------|------------|
| 2026-07-14 | Bolt 042 — thumbnail cache | `feat/bolt-042-thumbnail-cache` | Approve-with-followups (v2 verification; v2 follow-ups resolved) | 3 / 8 / 14 / 3 | **v1: 26 verified · CLOUD-1 deferred · 0 reopened** @`095285c`. **v2 follow-ups: NEW-1 fixed** (decode cap 50→100 MP, owner decision — accept large-format prints), **NEW-2 fixed** (restored upload kept on transient error), **NEW-4 fixed** (OS-independent `/` storage keys), **NEW-3 deferred** (latent cleanup/preview TOCTOU → bolt-043 orphan sweep), all @`e3a77d9`, each proven revert→red. Suites green: **.NET 515/515**, **frontend 403/403**. Awaiting v3 verification of NEW-1/2/4. Feature-closure still wants a saturated discovery pass. | [v2](042-thumbnail-cache/review-v2.md) | [v2](042-thumbnail-cache/resolution-v2.md) |
