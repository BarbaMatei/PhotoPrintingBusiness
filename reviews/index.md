...
| Target | State |
|---|---|
| 015 sameday shipping | **v2 verification 2026-07-27** (`727a018`) — 21/21 fixes held, 0 reopened (12 revert-and-rerun + 9 judgment/inspection). Verdict approve-with-followups. **Certification pair owed** before closure; still dormant behind two false flags. Owner action: set real Sameday service ids before enabling |
