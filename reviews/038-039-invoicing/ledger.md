...
| PPW-550 | 🟠 | v6 | InvoicesController's tier-mismatch fallback re-throws an unhandled FileNotFoundException on a double-tier blob miss | `Controllers/InvoicesController.cs:84-94` | fixed | `0ec6497` |
| PPW-551 | 🟠 | v6 | ANAF credential-failure log/capture dedup resets every tick, unlike the sibling cross-tick outage window | `Services/Invoicing/Anaf/InvoiceUploadJob.cs:92` | fixed | `0ec6497` |
