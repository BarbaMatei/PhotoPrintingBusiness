...
| PPW-342 | fixed | `6df47b2` | Every terminal webhook branch records payment_webhook_total and logs, incl. the legacy processor fall-through; new MetricCapture helper drives a MeterListener, 8 tests. Recorded from the commit — fixer cancelled before reporting (Decisions). |
