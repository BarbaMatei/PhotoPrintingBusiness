...
// Output: ACTION: auto|stop, then NEXT (auto only: delta discovery · lens-coverage discovery
// (<lens>) · certification (pair) · certification (single) · close the loop) and REASON.
