...
# Resolution v1 — 954-voided-misstamp

## Findings

| ID | Status | Commit | Note |
|---|---|---|---|
| PPW-9541 | fixed | `abcd222` | Blind re-posts capped. |
| PPW-9542 | fixed | `abcd222` | Key retired on confirmation only. |
| PPW-9543 | fixed | `abcd222` | Hand-over cancels the stale intent. |

## Scope

| Cluster | Findings | Files | Protocol |
|---|---|---|---|
| A — payment key | PPW-9541, PPW-9542, PPW-9543 | `Services/Trigger.cs`, `Services/Overlap.cs` | payment key lifecycle |
