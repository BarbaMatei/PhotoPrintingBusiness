...
| review system (meta) | Open, never archived: v1 on 2026-07-29 (14 standing, 13 later fixed, SF14 deferred), v2 on 2026-08-12 (21 findings, 0🔴/7🟠/10🟡/4⚪). <br> Worst now is SF16, reopened — the certification-watch check died in the 2026-08-11 regroup — plus five more dead or mis-wired mechanical checks (SF17–SF22). <br> v2's repair round (recommendations 1–2) awaits the owner's decision. Ids here are the `SF<n>` of the system reviews, outside the `PPW-<n>` sequence, because `reviews/system/` is out of the doc contracts' scope. |
