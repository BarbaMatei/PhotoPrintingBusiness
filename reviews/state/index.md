...
| Target | State |
|---|---|
| 038-039 invoicing | Open, v1 fix round resolved 2026-08-13 at `7cde815`: all 10 🔴 blockers and 15 🟠 fixed, 1 wont-fix by owner ruling (PPW-489). <br> `tests-coverage`/`db-parity` are still owed manifest lenses (PPW-497 — two requested lens keys were typos and silently dropped). <br> Next: an independent verification pass against `7cde815` — this round has not been self-verified. |
