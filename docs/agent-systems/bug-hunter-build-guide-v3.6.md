# Bug-Hunting Agent System — Complete Build Guide (v3.6, additive)
...
> profile. The normative contract reference is now **`docs/agent-systems/integration-contract-v1.5.md`**.
...
> normative contract reference is now **`docs/agent-systems/integration-contract-v1.5.md`**.
...
> **`docs/agent-systems/integration-contract-v1.5.md`**.
...
> cross-system interface is now normative in **`docs/agent-systems/integration-contract-v1.5.md`** (storage map, query
...
- **The Integration Contract is normative (v3.1).** Cross-system interfaces — storage layout and the
  ...
  `docs/agent-systems/integration-contract-v1.5.md` and win over any brief in this guide.
...
(`docs/agent-systems/integration-contract-v1.5.md` §3); keep flow IDs stable across refreshes.
...
envelope: `docs/agent-systems/integration-contract-v1.5.md` §2) for the contracts relevant to a location / flow / symbol;
...
is stale** beyond the threshold (`docs/agent-systems/integration-contract-v1.5.md` §5) before relying on oracle results
...
re-distilling the fixed bug's contract (`docs/agent-systems/integration-contract-v1.5.md` §4); on a fix that fails its
...
`docs/agent-systems/integration-contract-v1.5.md` §4) (v3.1). By AI-DLC convention, the bug-bolt created from this
