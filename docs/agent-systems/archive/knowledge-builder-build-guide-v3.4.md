# Knowledge-Builder System — Complete Build Guide (v3.4, additive)
...
lives in the standalone, normative **`docs/agent-systems/integration-contract-v1.4.md`** — both systems build against
...
> normative contract reference is now **`docs/agent-systems/integration-contract-v1.4.md`**, and the
> bug-hunter spec of record is **`docs/agent-systems/bug-hunter-build-guide-v3.5.md`**.
...
> - **The Integration Contract is extracted** *(F5)* to `docs/agent-systems/integration-contract-v1.4.md` (standalone,
...
Integration Contract §5); the gitignored code index is never part of this commit (v3.4); remove the
run lock — on
...
The normative cross-system interface lives in **`docs/agent-systems/integration-contract-v1.4.md`**: storage layout +
...
> record is now `docs/agent-systems/bug-hunter-build-guide-v3.5.md` (review hardening, same day),
...
1. **Part I:** reference `docs/agent-systems/integration-contract-v1.4.md` as normative (shared tools, interleave,
