# Bug-Hunting Agent System — Complete Build Guide (v3.5, additive)
...
> normative contract reference is now **`docs/agent-systems/integration-contract-v1.4.md`**.
...
> **`docs/agent-systems/integration-contract-v1.4.md`**.
...
> cross-system interface is now normative in **`docs/agent-systems/integration-contract-v1.4.md`** (storage map, query
...
- **The Integration Contract is normative (v3.1).** Cross-system interfaces — storage layout and the
  ...
  `docs/agent-systems/integration-contract-v1.4.md` and win over any brief in this guide.
...
§5); the gitignored code index is never part of this commit (v3.5); remove the run lock — **on success
or abort**. Define
...
(`docs/agent-systems/integration-contract-v1.4.md` §3); keep flow IDs stable across refreshes.
...
envelope: `docs/agent-systems/integration-contract-v1.4.md` §2) for the contracts relevant to a location / flow / symbol;
...
is stale** beyond the threshold (`docs/agent-systems/integration-contract-v1.4.md` §5) before relying on oracle results
...
re-distilling the fixed bug's contract (`docs/agent-systems/integration-contract-v1.4.md` §4); on a fix that fails its
...
`docs/agent-systems/integration-contract-v1.4.md` §4) (v3.1). By AI-DLC convention, the bug-bolt created from this
