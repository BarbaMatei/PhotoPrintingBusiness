# Knowledge-Builder System — Complete Build Guide (v3.5, additive)
...
lives in the standalone, normative **`docs/agent-systems/integration-contract-v1.5.md`** — both systems build against
...
> normative contract reference is now **`docs/agent-systems/integration-contract-v1.5.md`**, and the
> bug-hunter spec of record is **`docs/agent-systems/bug-hunter-build-guide-v3.6.md`**.
...
> - **The Integration Contract is extracted** *(F5)* to `docs/agent-systems/integration-contract-v1.5.md` (standalone,
...
The normative cross-system interface lives in **`docs/agent-systems/integration-contract-v1.5.md`**: storage layout +
...
> record is now `docs/agent-systems/bug-hunter-build-guide-v3.6.md` (review hardening, same day),
...
1. **Part I:** reference `docs/agent-systems/integration-contract-v1.5.md` as normative (shared tools, interleave,
