...
> the review file deleted by `b4329a8` — read it with `git show b4329a8^:docs/agent-systems/reviews/cross-system-review-v4-2026-06-15.md`): the sole-writer convention now
...
> the review file deleted by `b4329a8` — read it with `git show b4329a8^:docs/agent-systems/reviews/cross-system-review-v3-2026-06-12.md`): the orchestrator's Open
...
> the review file deleted by `b4329a8` — read it with `git show b4329a8^:docs/agent-systems/reviews/cross-system-review-v2-2026-06-12.md`): the ledger gains a
...
> G4, G11, G12, G13 in the review file deleted by `b4329a8` — read it with `git show b4329a8^:docs/agent-systems/reviews/cross-system-review-v1-2026-06-11.md`) — all
